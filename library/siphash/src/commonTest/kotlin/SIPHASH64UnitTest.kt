...
open class SIPHASH64UnitTest : SiphashUnitTest() {

    final override val validKey: ByteArray = ByteArray(16) { it.toByte() }
    final override val expectedAlgorithm: String = "SipHash"
    final override val expectedResetHash: String = "310e0edd47db6f72"
    final override val expectedUpdateSmallHash: String = "21d269dd12d98f33"
    final override val expectedUpdateMediumHash: String = "e635b1b821db25e1"

    override fun mac(key: ByteArray): Mac = SIPHASH64(key)
